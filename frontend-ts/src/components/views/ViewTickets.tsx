  ...
  return (
    <>
      <Header
        ...
        subtext={
          "View your unclaimed tickets, your open tickets, and your closed tickets."
        }
      />
      <div className="hidden lg:flex justify-between gap-4 grid grid-cols-3 w-100">
        <Card className="col-span-1 w-1/3 border-gray-200 rounded-none">
          <CardTitle className="text-center py-4">Unclaimed Tickets</CardTitle>
          <CardContent>
                  ...
                  <Card className="w-full border-gray-400 rounded-none shadow-none m-0 p-0">
                    ...
                    <div className="px-2 pb-1">
                      <div className="flex justify-between text-gray-400 font-light tracking-tighter text-xs">
                        ...
                        <div className="flex">
                          <a
                            className="px-1 underline hover:text-red-600"
                            href="/"
                          >
                            view
                          </a>
        ...
        <Card className="col-span-1 w-1/3 border-gray-200 rounded-none">
          <CardTitle className="text-center py-4">Open Tickets</CardTitle>
          <CardContent>
            {ticketData.map((value) => (
              <div className="mt-2">
                {value.status == "open" && (
        ...
        <Card className="col-span-1 w-1/3 border-gray-200 rounded-none">
          <CardTitle className="text-center py-4">Closed Tickets</CardTitle>
          <CardContent>
            {ticketData.map((value) => (
              <div className="mt-2">
                {value.status == "closed" && (
