...
export default function CreateTicket() {
	...
	function onSubmit(values: z.infer<typeof formSchema>) {
		toast({
			...
			description: <><span className="font-base">Thanks, <span className="font-semibold">{values.firstname}.</span> A tutor will be with you shortly.</span></>,
			variant: "default",
								...
								render={({ field }) => (
									<FormItem>
										...
										<Select onValueChange={field.onChange} defaultValue={field.value}>
											<FormControl>
												<SelectTrigger>
													<SelectValue className="text-stone-500" placeholder="Select modality" />
												</SelectTrigger>
											</FormControl>
											<SelectContent>
