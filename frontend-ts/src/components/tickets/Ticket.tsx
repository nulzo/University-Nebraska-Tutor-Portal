    ...
    <Card>
      ...
      <CardContent className=" relative pb-20">
        <div className="absolute left-6 bottom-14 text-xs font-medium text-muted-foreground">
          Created at:{" "}
          {(start_date && `${start_hour}, ${start_date}`) ||
            "Time Error... you shouldn't be seeing this! - Nolan"}
        </div>
        {type === "opened" && (
        ...
        <Button
          variant={"link"}
          className="absolute right-0 bottom-1 text-xs font-medium text-xs text-foreground font-medium hover:dark:text-online"
        >
          Claim
        ...
        <Button
          variant={"link"}
          className="absolute right-20 bottom-1 text-xs font-medium text-xs text-foreground font-medium hover:dark:text-warning"
        >
          Close
