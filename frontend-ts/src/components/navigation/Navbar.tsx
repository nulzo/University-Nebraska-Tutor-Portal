    ...
    <>
      ...
      >
        <div className={"grid grid-cols-3 gap-4 w-full"}>
          ...
          <div
            className={
              "flex items-center hidden sm:flex justify-end col-span-1"
            }
          >
            <ul className={"flex items-center space-x-6"}>
              <li
                className={
                  "font-thin text-gray-700 transition ease-in-out hover:duration-150 hover:text-red-600"
                }
              >
                <div className={"font-medium"}>
                  <a
                    href={"/"}
                    className={
                      "flex flex-wrap content-center [&>p]:flex group "
                    }
                  >
                    <div className={""}>Login</div>
                    <p
                      className={
                        "pl-1 flex-wrap content-center transition-transform duration-300 group-hover:translate-x-0.5"
                      }
                    >
                      <svg
                        width="15"
