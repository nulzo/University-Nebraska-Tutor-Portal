...
function AnnouncementIcon({ variant }: any) {
    switch (variant) {
        ...
        case "info":
            return (
                <InfoIcon className="h-4 w-4 mr-2 stroke-info" />
            );
        case "warning":
            return (
                <AlertOctagonIcon className="h-4 w-4 mr-2 stroke-warning" />
            );
        case "tutor":
            return (
                <UsersIcon className="h-4 w-4 mr-2 stroke-fortutor" />
            )
    }
}
