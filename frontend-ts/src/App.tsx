          ...
          <div className="border-t">
            <div className="bg-background">
              <div className="grid lg:grid-cols-5">
                {user === "Student" && <SidebarStudent className="hidden lg:block" ></SidebarStudent>}
                {user === "Tutor" && <Sidebar className="hidden lg:block" ></Sidebar>}
                {user === "Admin" && <SidebarAdmin className="hidden lg:block"></SidebarAdmin>}
