            ...
            <div className="flex flex-col sm:block">
                <Tabs defaultValue="today" className="space-y-4">
                        ...
                        <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
                            <Card className="w-[100%] md:w-full">
                                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                    ...
                                    <LayersIcon className="stroke-foreground" height={16} width={16} viewBox="0 0 24 24" strokeWidth={2} />
                                </CardHeader>
                                <CardContent>
                            ...
                            <Card className="w-[100%] md:w-full">
                                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                    ...
                                    <FileX2Icon width={16} height={16} className="stroke-foreground" viewBox="0 0 24 24" />
                                </CardHeader>
                                <CardContent>
                    ...
                    <TabsContent value="new" className="">
                        <Label className="text-base text-foreground">New and Unclaimed Tickets</Label>
                        <CardDescription>
                            Below are the currently unclaimed tickets. Please claim tickets that you are working on.
                        </CardDescription>
                        <Separator className="mb-4 mt-2" />
                        <CardContent className="space-y-4">
                            {!loading && tickets.data && tickets.data.map((ticket: any) => (
                                <Ticket name={ticket.student} professor={ticket.professor} description={ticket.description} section={ticket.section} started={ticket.started} completed={ticket.completed} start_time={ticket.start_time} type={"new"} />
                            ))}
                        </CardContent>
                    </TabsContent>
