# Generated by Django 4.2.7 on 2023-12-22 22:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("semester_term_name", models.CharField(max_length=20)),
                (
                    "semester_code",
                    models.IntegerField(
                        choices=[
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="usertocoursetaken", to="api.course"
                    ),
                ),
                (
                    "courses_tutoring",
                    models.ManyToManyField(
                        blank=True, related_name="usertocoursetutored", to="api.course"
                    ),
                ),
            ],
            managers=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "semester",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="api.semester"
                    ),
                ),
            ],
            options={
