...
urlpatterns = [
    ...
    path("api/tickets/professor/<str:professor_pk>/",
         view=routing.ProfessorTicketDetailView.as_view(), name="Professor Tickets"),
    path("api/tickets/section/<str:section_pk>/",
         view=routing.SectionTicketDetailView.as_view(), name="Section Tickets"),
    path("api/tickets/tutor/<str:tutor_pk>",
