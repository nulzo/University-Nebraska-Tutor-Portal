...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            managers=[
                ("issue", django.db.models.manager.Manager()),
            ],
        ),
        migrations.CreateModel(
            name="Messages",
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="professortocourse", to="api.course"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("modality", models.CharField(default="In-Person", max_length=10)),
                ...
                (
                    "tickets",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="api.ticket"
                    ),
                ),
            ],
            options={
