...
export default function TutorView() {
  ...
  return (
    <>
      <Header
        text="CSLC Tutors"
        subtext={<>View the tutors and the classes they can tutor.</>}
      />
      <Separator className="" />
      <div className="grid grid-cols-8 min-h-screen">
        ...
        <div className="col-span-6">
          <Card className="ml-16 mt-8 ">
            ...
            <CardContent>
              <div className="flex">
                ...
                <div className="ml-5 mt-4 text-primary space-y-2">
                  <div className="">
                    <span className="font-bold">Name:</span> STUDENT_NAME
                  </div>
                  <div className="">
                  ...
                  <div className="">
                    <span className="font-bold">Email:</span> STUDENT_EMAIL
                  </div>
                </div>
              </div>
              <div>
                <div className="mt-4">
                  <span className="font-bold">About Me:</span> STUDENT_BIO
                </div>
              </div>
            </CardContent>
            <CardDescription className="flex ml-5 mb-4 space-x-2">
              <div className="flex items-center content-center">
                ...
                <div className="mr-2 ml-1 text-sm text-muted-foreground">
                  Tutor Since:
                </div>
          ...
          <div className="text-foreground ml-16 pt-16">
            <div className="text-xl font-bold">STUDENT_NAME can tutor:</div>
              ...
              <Table>
                ...
                <TableBody>
                  <TableRow key="tablerow" className="h-3">
                    <TableCell className="p-2 font-medium">CIST-1400</TableCell>
                    <TableCell>Computer Science I</TableCell>
                    <TableCell className="text-right pr-2">High</TableCell>
                  </TableRow>
                  <TableRow key="tablerow2" className="h-3">
                    <TableCell className="p-2 font-medium">CSCI-1620</TableCell>
                    <TableCell>Computer Science II</TableCell>
                    <TableCell className="text-right pr-2">High</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
