...
//             Thanks, <span className="font-semibold">{values.name}.</span> A
...
//             <>
//               <p>
//                 When submitting your ticket, include your name, email,
//                 professor's name, course details, and a clear description of the
//                 problem or question you need assistance with.
//               </p>
...
//                   render={({ field }) => (
//                     <>
//                       <FormLabel>Select to test the claimed feature</FormLabel>
//                       <FormItem>
//                         <FormControl>
//                           <Checkbox
//                             checked={field.value}
...
//                   render={({ field }) => (
//                     <>
//                       <FormLabel>Select to test the closed feature</FormLabel>
//                       <FormItem>
//                         <FormControl>
//                           <Checkbox
//                             checked={field.value}
...
//               <Button variant="default">Submit Ticket</Button>
//             </div>
//           </form>
//         </Form>
//       </div>
