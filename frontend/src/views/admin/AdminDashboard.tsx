    ...
    <>
      ...
      <div className="flex flex-col sm:block">
        <Tabs defaultValue="today" className="space-y-4">
          <TabsList>
            <TabsTrigger value="today">Overview</TabsTrigger>
            <TabsTrigger value="new">New</TabsTrigger>
            <TabsTrigger value="open">Claimed</TabsTrigger>
            <TabsTrigger value="closed">Closed</TabsTrigger>
          </TabsList>
          <TabsContent value="today" className="">
            <Label className="text-base text-foreground">CSLC Overview</Label>
            <CardDescription>
              Data is collected from a finite timeframe and displayed for
              analysis purposes.
            </CardDescription>
