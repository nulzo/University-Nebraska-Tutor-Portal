  ...
  return (
    <div>
      ...
      <div className="pt-2 pb-6">
        <Announcement className="" variant="alert" title="Heads up!" body="You can skip typing out your name and email every time you submit a ticket if you login to the app!"></Announcement>
      </div>
      <TicketForm />
    </div>
  );
